package io.github.sinri.yarn.weaver.sdk.hadoop.YarnSite.v1.ResourceManager.cluster.container;
...
import io.github.sinri.yarn.weaver.sdk.hadoop.YarnSite.v1.entities.container.ContainerSignal;
...
public class ClusterContainerSignalRequest extends YarnSiteV1Request<ClusterContainerSignalRequest.SignalDone> {
    ...
    @Override
    public Future<SignalDone> request() {
