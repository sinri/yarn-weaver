...
import io.github.sinri.yarn.weaver.sdk.hadoop.YarnSite.v1.entities.node.Node;
import io.github.sinri.yarn.weaver.sdk.hadoop.YarnSite.v1.entities.node.NodeState;
...
public class ClusterNodesRequest extends YarnSiteV1Request<ClusterNodesRequest.ClusterNodes> {
    ...
    @Override
    public Future<ClusterNodes> request() {
